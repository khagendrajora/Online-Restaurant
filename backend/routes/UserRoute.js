...
const { createUser, login, userDetail, postEmailConfirmation, deleteUser, forgetPwd, resetPwd, signOut, userList, requireUser, requireAdmin, userEdit } = require('../controllers/UserController')   // while importinfg function use {}
